class CareDeckPage {
  ...
  get PublicSafetyDataHeader() {
    return $(".d-flex.align-items-center.header-btn.position-relative.header-block.justify-content-between.psd-toggle")
  }
  ...
  get BtnPSDArrow() {
    return $("//button[@class='btn btn-xs public-btn-arrow psd-arrow']//*[name()='svg']")
  }
  get BtnCall() {
  ...
  async ClickPSDArrowButton() {
    await this.BtnPSDArrow.click()
  }
  async ClickDropAudioCall() {
    await this.BtnDropAudioCall.waitForEnabled()
